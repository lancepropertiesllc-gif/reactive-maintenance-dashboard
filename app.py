...
st.markdown("**Built for operators who wait until it breaks** — Upload your data and see the coming cash flow pain")

# ==================== SAMPLE TEMPLATE DOWNLOAD ====================
st.subheader("📥 Step 1: Download Sample Template")
sample_csv = """Property,Date,Issue_Type,Repair_Cost,Downtime_Days,Age_Years,Unit_Count,Notes
Building A - Chesterfield,2025-01-15,HVAC,2450,5,11,24,Replaced blower motor
Building A - Chesterfield,2025-02-03,Water Heater,1850,8,9,24,Tank leaked
Building B - St. Charles,2025-01-22,Plumbing,980,2,14,16,Clogged main line
Building B - St. Charles,2025-03-10,Electrical,3200,4,7,16,Panel upgrade
Building C - Wentzville,2025-02-18,Roof,6800,12,18,32,Multiple leaks
Building D - North County,2025-04-05,Appliances,650,1,12,20,Refrigerator failed
Building E - Downtown,2025-03-01,Pest Control,450,0,5,12,"""
...
st.download_button(
    ...
    mime="text/csv",
    help="Send this to your client — they just fill it out and upload"
)

st.divider()

# ==================== FILE UPLOADER ====================
uploaded_file = st.file_uploader("Step 2: Upload your maintenance data CSV", type="csv")

if uploaded_file is not None:
    df = pd.read_csv(uploaded_file)
    st.success(f"✅ Loaded {len(df)} records from {df['Property'].nunique()} properties")
else:
    st.info("👆 Upload a CSV using the template above to see the risk analysis")
    st.stop()
