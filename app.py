...
if uploaded_file is not None:
    ...
    if 'Issue_Type' in df.columns:
        ...
        st.error("CSV must contain an 'Issue_Type' or 'Issue Type' column")
        st.stop()
...
When a Replacement Cost Estimate is provided, it is used for more accurate projections on major items such as roofs and HVAC systems.
""")
