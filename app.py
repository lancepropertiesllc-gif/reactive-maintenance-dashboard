...
if uploaded_file is not None:
    ...
    # Force column name standardization
    if 'Issue_Type' in df.columns:
        df = df.rename(columns={'Issue_Type': 'Issue Type'})
    elif 'Issue Type' in df.columns:
        pass  # already correct
    else:
        st.error("Error: CSV must contain an 'Issue_Type' column. Please use the sample template.")
        st.stop()
...
# Risk Calculation - Use the standardized column name
